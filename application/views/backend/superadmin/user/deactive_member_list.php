<div class="page-wrapper">
	<div class="page-content">
		...
		<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
			<div class="breadcrumb-title pe-3">Deactive User List</div>
			<div class="ps-3">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0 p-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>SDashboard"><i class="bx bx-home-alt"></i></a>
						</li>
						<li class="breadcrumb-item active" aria-current="page">Deactive User List</li>
					</ol>
				</nav>
			</div>
		</div>
			...
			<div class="card-body">
			  <div class="border p-4 rounded">
				<div class="card-title d-flex align-items-center">
					...
					<h5 class="mb-0 text-info">Deactive User List</h5>
				</div>
...
<script>
  ...
  if (result.isConfirmed) {
            ...
            $.ajax({
             ...
             data: {user_id: member_id,status:'Active'},
             error: function() {
             },
             cache: false,
